...
export default function PaginaComercios({barriosData, comerciosData}){

  const peluIcon = L.icon({
      iconUrl: 'hairdresser.png',
      iconSize:     [24, 24]
  });  
  
  const panIcon = L.icon({
      iconUrl: 'bread.png',
      iconSize:     [24, 24]
  });
  ...
  return (
    <MapContainer center={[42.85, -2.68]} zoom={12} minZoom={11} maxZoom={17} maxBounds={[[42.78, -2.78],[42.92, -2.55]]} style={{ height: "500px", width: "100%" }}>
